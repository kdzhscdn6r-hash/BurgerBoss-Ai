...
* Help me prepare for a busy weekend.
...
4. Task — Defines what the AI needs to accomplish.
6. Context — Provides relevant workplace information.
8. Inputs — Provides the user’s specific information.
10. Rules — Defines limitations and requirements.
...
* Check meeting summaries against the original notes.
* Confirm deadlines and responsibilities.
* Review AI-generated task plans.
* Avoid relying solely on AI for important operational decisions.
